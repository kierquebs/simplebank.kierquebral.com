...
import (
	...
	mockdb "github.com/kierquebs/simplebank.kierquebral.com/db/mock"
	...
	mockwk "github.com/kierquebs/simplebank.kierquebral.com/worker/mock"
	...
	testCases := []struct {
	...
	}{
		{
			...
			checkResponse: func(t *testing.T, res *pb.CreateUserResponse, err error) {
				...
				require.Equal(t, user.MiddleName, createdUser.MiddleName)
